...
export const InstructionsInputForm = () => {
    const [instructions, update] = useState({ // update is the setter fx, it will be how we update the instructions  info to API
            "instructions": "",
        });
    ...
    const saveInstructions = (SubmitInstructionsClicked) => {
        ...
        return fetch("http://localhost:8788/instructions", fetchOption)
            .then(() => {
